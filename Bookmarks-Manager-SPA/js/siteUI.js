...
async function renderBookmarks() {
    ...
    eraseContent();
    if (bookmarks !== null) {
        updateDropDownMenu([...new Set(bookmarks.map(bookmark => bookmark.Category))]);
...
function renderBookmarkForm(bookmark = null) {
    ...
    $("#content").append(`
        <form class="form" id="bookmarkForm">
            ...
            <img id="faviconPreview" src="${Favicon(bookmark.Url)}" alt="Favicon Preview" style="display: block; width: 64px; height: 64px; margin-bottom: 10px;"/>
